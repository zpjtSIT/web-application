...
class Rooms {
  ...
  public function getAllRooms() {
    $rooms = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3000/schoolroom", ""));
  ...
  public function updateRoomDetail($data) {
    ...
    $response = $this->getCurl("PUT", 'http://ict2103group12.tk:3000/schoolroom/admin/' . $data['id'], $data);
    echo $response;
  }
  ...
  public function addRoomDetail($data) {    
    ...
    $response = $this->getCurl("POST", 'http://ict2103group12.tk:3000/schoolroom/admin/', $data);
    echo $response;
  }
}
?>