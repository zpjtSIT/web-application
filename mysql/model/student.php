...
class student {
  ...
  public function getAllStudent() {
    $student = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3000/student/admin", ""));
  ...
  public function getStudentWithNoAccount() {
    $studentWithNoAccount = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3000/student/studentlist/noaccount", ""));
...
//       "image"     => '/image/event/123123.png',
    ...
    $response = $this->getCurl("PUT", 'http://ict2103group12.tk:3000/student/admin/' . $data['matrics'], $data);
    echo $response;
  }
  ...
  public function addStudentDetail($data) {    
    ...
    $response = $this->getCurl("POST", 'http://ict2103group12.tk:3000/student/admin/', $data);
    echo $response;
  }
}
?>