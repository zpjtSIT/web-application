          ...
          <table id="dataTable" class="table table-bordered table-striped" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img style="width: 50px; height: 50px;" src="<?php echo 'http://ict2103group12.tk:3000' . $adminProfiles->adminimage;?>"></td>
    ...
    <form method="post" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="matric" id="edit_adminmatric" class="form-control" maxlength="10" disabled/>
          <br />
...
<script>
  ...
  $('#dataTable').on('click', 'tbody #edit_button', function() {
   ...
   // $("#dept option[text=" + data_row[7] +"]").attr("selected","selected");
    //$("#edit_admindepartment").val(3).change();
   ...
   // $("#edit_admindepartment option[value='" + data_row[8] + "']").prop('selected', true)
