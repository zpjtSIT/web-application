  ...
  <article id="content-wrapper">
    <section class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo $language_fault_title; ?></li>
      </ol>
    </section>
  </article>
  <!-- All Student Datas -->
  <div class="container-fluid">
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i> <?php echo $language_fault_title; ?>
      </div>
      <!-- Table data -->
      <div class="card-body">
        <div class="table-responsive">
          ...
          <table id="dataTable" class="table table-bordered table-striped" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th><?php echo $language_fault_id; ?></th>
                <th><?php echo $language_date_reported; ?></th>
                <th><?php echo $language_image; ?></th>
                <th><?php echo $language_fault_location; ?></th>
                <th><?php echo $language_fault_room; ?></th>
                <th><?php echo $language_description; ?></th>
                <th><?php echo $language_fault_status; ?></th>
            ...
            <tbody>
              <?php $faultAllFaults = new faults();
               ...
               ?>
                <tr>
                  <td><?php echo $faults->id;?></td>
                  <td><?php echo date("Y-m-d H:i:s", strtotime($faults->date));?></td>
                  <td><img style="width: 50px; height: 50px;" src="<?php echo 'http://ict2103group12.tk:3001' . $faults->image;?>"></td>
                  <td><?php echo $faults->location;?></td>
                  <td><?php echo $faults->classroom;?></td>
                  <td><?php echo $faults->description;?></td>
                  <td><?php echo $faults->fixed;?></td>
