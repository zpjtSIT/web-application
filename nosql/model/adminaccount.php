...
class adminAccount {
  private function getCurl($requestType, $url, $data) {
    ...
    $admin = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3001/admin/admin", ""));
  ...
  public function createAdminProfile($data) {    
    ...
    $response = $this->getCurl("POST", 'http://ict2103group12.tk:3001/admin/admin/', $data);
    echo $response;
  }
  ...
  public function updateAdminProfile($data) {
    ...
    $response = $this->getCurl("PUT", 'http://ict2103group12.tk:3001/admin/admin/' . $data['matrics'], $data);
    echo $response;
  }
  ...
  public function createAdminAccount($data) {
    ...
    $response = $this->getCurl("POST", "http://ict2103group12.tk:3001/login/admin/admin/" . $data['id'], $data);
    echo $response;
  }
