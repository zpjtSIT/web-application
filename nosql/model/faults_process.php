...
class faults {
  ...
  public function getAllFaults(){
    $faults = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3001/fault", ""));
    return $faults->respond;
  }
  
  public function getFaultCloud(){
    $faultCloud = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3001/faultcloud/cloud", ""));
    return $faultCloud->respond;
  }
  
  public function getFaultChart(){
    $faultChart = json_decode($this->getCurl("GET", "http://ict2103group12.tk:3001/faultcloud/chart", ""));
  ...
  public function updateFaultDetail($data) {
    ...
    $response = $this->getCurl("PUT", "http://ict2103group12.tk:3001/fault/admin/" . $data['id'], $data);
    echo $response;
  }
}
?>